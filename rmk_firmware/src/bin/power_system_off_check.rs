//! Lowest-power diagnostic using the same safe GPIO state as
//! `power-baseline-check`, followed by nRF52840 System OFF.
//!
//! The board can only leave System OFF by reset or a full power cycle because
//! this diagnostic intentionally configures no GPIO wake source.
...
async fn main(_spawner: Spawner) {
    info!("On the 15 v4 power System OFF check firmware");
