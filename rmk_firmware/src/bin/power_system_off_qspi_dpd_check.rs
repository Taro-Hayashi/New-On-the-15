//! System OFF diagnostic after placing the XIAO onboard QSPI flash in DPD.
...
async fn main(_spawner: Spawner) {
    info!("On the 15 v4 power System OFF QSPI DPD check firmware");
    ...
    qspi_config.deep_power_down = Some(DeepPowerDownConfig {
        // P25Q16H timings from the XIAO BLE Zephyr board definition.
        enter_time: 188, // 3,000 us / 16 us, rounded up
        exit_time: 500,  // 8,000 us / 16 us
    });
    let qspi = Qspi::new(
        p.QSPI,
        Irqs,
