...
pub const fn get_default_keymap() -> [[[KeyAction; COL]; ROW]; NUM_LAYER] {
    [
        layer!([
            [lt!(1, Escape), k!(Kc1), k!(Kc2), k!(Kc3), k!(Kc4), k!(Kc5), k!(Kc6), a!(No), k!(LCtrl), k!(A), k!(S), k!(D), k!(F), k!(G), k!(Language2), a!(No), k!(Kc7), k!(Kc8), k!(Kc9), k!(Kc0), k!(Minus), k!(Equal), k!(Grave), k!(Backspace), k!(Language1), k!(H), k!(J), k!(K), k!(L), k!(Semicolon), k!(Quote), k!(Enter)],
            [k!(Tab), k!(Q), k!(W), k!(E), k!(R), k!(T), k!(LGui), a!(No), k!(LShift), k!(Z), k!(X), k!(C), k!(V), k!(B), lt!(2, Space), a!(No), k!(LAlt), k!(Y), k!(U), k!(I), k!(O), k!(P), k!(LeftBracket), k!(RightBracket), lt!(2, Space), k!(N), k!(M), k!(Comma), k!(Dot), k!(Slash), k!(Backslash), k!(RShift)],
