...
<table>
    ...
    <tr><td rowspan="3"></td><td>メイン基板</td><td>1</td><td></td></tr>
    <tr><td>アクリルプレート</td><td>2</td><td>白・透明</td></tr>
    <tr><td>プリント品</td><td></td><td></td></tr>
    <tr><td>1</td><td>M2 × 5mmネジ</td><td>6</td><td></td></tr>
    <tr><td>2</td><td>M2 × 6mmネジ</td><td>9</td><td></td></tr>
    <tr><td>3</td><td>M2 × 8mmネジ</td><td>4</td><td></td></tr>
    <tr><td>4</td><td>M2 × 10mmネジ</td><td>9</td><td></td></tr>
    <tr><td>5</td><td>M2 × 5mmスペーサー</td><td>8</td><td></td></tr>
    <tr><td>6</td><td>M2ナット</td><td>10</td><td></td></tr>
    <tr><td>7</td><td>2Uスタビライザー</td><td>1</td><td>プレートマウント</td></tr>
    <tr><td>8</td><td>電池端子</td><td>4</td><td>プラス・マイナス 各2</td></tr>
    <tr><td>9</td><td>スライドスイッチ</td><td>1</td><td></td></tr>
    <tr><td>10</td><td>サイドスイッチ</td><td>2</td><td></td></tr>
    <tr><td>11</td><td>ゴム足</td><td>8</td><td></td></tr>
    <tr><td>12</td><td>ポゴピン</td><td>1対</td><td>2.8mmピッチ</td></tr>
    <tr><td>13</td><td>USB基板</td><td>1</td><td></td></tr>
    <tr><td>14</td><td>フレキシブル基板</td><td>2</td><td>1枚のシートになっています</td></tr>
    <tr><td>15</td><td>マグネット</td><td>4</td><td>直径6mm × 厚さ2mm</td></tr>
    <tr><td>16</td><td>ピンヘッダー</td><td>1</td><td>40ピン</td></tr>
    <tr><td>17</td><td>MXスイッチソケット</td><td>60</td><td></td></tr>
</table>
...
- [`onthe15-test-x15-zmk.uf2`](https://github.com/Taro-Hayashi/New-On-the-15/releases/latest/download/onthe15-test-x15-zmk.uf2)
...
![](./img/IMG_5556.jpg)
レイアウトに合わせて使用するスイッチブロックが変わります。今回は2Uサイズは1Ux2を8個、3Uサイズは1Ux3を3個、2U+1Uを1個、4x4サイズは2個になります。
![](./img/IMG_5271.jpg)
...
![](./img/IMG_4953.jpg)
LED66まではんだ付けします。
![](./img/IMG_4955.jpg)表面のLED1〜6は後まわしにしています。XIAO以外のはんだ付けは順番を入れ替えても大丈夫です。
### 4.2 MXスイッチソケットのはんだ付け
SW1からSW60まで、向きに気をつけて置きはんだ付けします。
![](./img/IMG_4959.jpg)
...
![](./img/IMG_4974.jpg)
### 4.5 電池端子のはんだ付け
画像のプリント品と、ニッパーで切り出した2ピンのピンヘッダー4本を使います。
![](./img/IMG_4981.jpg)
...
JP1+とJP2+にはバネのないプラス端子、JP1-とJP2-にバネのあるマイナス端子を差し込みはんだ付けします。
外周側ではなく内周側のピンです。
![](./img/IMG_5021.jpg)

やけどに気を付けて、ピンセットを使って電池が入る方向に押さえながらはんだ付けすると作業しやすいです。
![](./img/IMG_5027.jpg)
...
裏返して足を切り、はんだ付けします。
![](./img/IMG_5115.jpg)
画像のプリント品と磁石、透明で小さいインジケーターディフューザーを使います。蓋を磁石式にする場合は磁石も使用します。
...
![](./img/IMG_5319.jpg)
4x4サイズははんだ付けされている場所に切り欠きを合わせます。
![](./img/IMG_5308.jpg)
2Uキーにスタビライザーを使用する場合、段差に引っ掛けながらスイッチブロックに取り付けます。
![](./img/IMG_5317.jpg)
ツメがある側、スタビライザーのバーがある側が手前になります。![](./img/IMG_5361.jpg)
### 4.11 本体の組み立て

画像のプリント品と10mmネジ4本、ナット4つを使用します。ネジの長さはプリント品のゲージで測ることができます。
![](./img/IMG_5418.jpg)
...
![](./img/IMG_5423.jpg)
8mmネジ4本、10mmネジ1本、ナット1個、スペーサーを4つを取り出します。
![](./img/IMG_5459.jpg)
4箇所に8mmネジとスペーサー、中央の1箇所に10mmネジとナットを固定します。
![](./img/IMG_5463.jpg)
![](./img/IMG_5474.jpg)
画像のプリント品と5mmネジ2本、6mmネジ1本、10mmネジ2本、スペーサー4つ、ナット1個を使用します。![](./img/IMG_5498.jpg)
LRボタンは大きくて押しやすいものと見た目が目立たないものの2種類から選べます。
![](./img/IMG_5977.jpg)
両端は10mmネジとスペーサー、内側2箇所は5mmネジとスペーサー、中央は6mmネジとナットで固定します。
![](./img/IMG_5485.jpg)
![](./img/IMG_5477.jpg)
アクリルプレート2枚と6mmネジ8つを使用します。
![](./img/IMG_5504.jpg)
アクリルプレートから保護シールを剥がし、6mmネジで固定します。![](./img/IMG_5510.jpg)
磁石式にする場合は向きを気を付けて、電池の蓋になるプリント品に磁石をはめ込みます。外れる場合はエポキシ接着剤で固定してください。
![](./img/IMG_5525.jpg)
ネジで固定する場合は5mmネジを外して10mmネジで固定してください。
![](./img/IMG_5535.jpg)
...
ドックではなく本体をUSBケーブルでPCと接続し、左上のキーを押しながらRボタンを押すと新しいドライブが現れます。対応するuf2ファイルをドラッグ&ドロップします。
![](./img/boot.jpg)
